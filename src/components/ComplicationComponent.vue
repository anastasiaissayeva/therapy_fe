...
<script>
import ComplicationEditForm from './ComplicationEditForm.vue';
export default {
  components: {
    ComplicationEditForm
  },
  props: {
    id: {
      type: Number,
  ...
  methods: {
    ...
    edit_item(id, name, alt_name, selectedLocation) {
      this.$emit("edit_item", id, name,alt_name, selectedLocation);
