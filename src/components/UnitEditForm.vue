...
<div>
    ...
    <div class="modal-overlay">
      <div class="modal">
        ...
        <form id="EditForm">
          <textarea form="EditForm" v-model.lazy.trim="new_name" placeholder="Сокращенное название" rows="2" />
...
export default {
  ...
  methods: {
    ...
    onSave() {
      this.$emit('edit_item', this.id, this.new_name,this.new_full_name, this.new_note);
