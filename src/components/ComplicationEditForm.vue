...
<div>
    ...
    <div class="modal-overlay">
      <div class="modal">
        ...
        <form id="EditForm">
          <textarea form="EditForm" v-model.lazy.trim="new_name" placeholder="Название осложнения" rows="2" required/>

          <textarea form="EditForm" v-model.lazy.trim="new_alt_name" placeholder="Альтернативное название осложнения" rows="2" />

          <select class="styled-select" id="locationSelect" v-model="selectedLocation">
...
export default {
  ...
  methods: {
    ...
    onSave() {
    this.$emit('edit_item', this.id, this.new_name, this.new_alt_name, this.selectedLocation, this.new_note);
    },
    onCancel() {
