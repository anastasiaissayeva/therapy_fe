...
<div>
    ...
    <div class="modal-overlay">
      <div class="modal">
        ...
        <form id="EditForm">
          <textarea form="EditForm" v-model.lazy.trim="new_name" placeholder="Название стадии" rows="2" required/>

          <textarea form="EditForm" v-model.lazy.trim="new_note" placeholder="Описание стадии" rows="4" />
        </form>
